...
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your NEVM network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new NEVM network down to  |")
	...
	log.Info("Administering NEVM network", "name", w.network)
